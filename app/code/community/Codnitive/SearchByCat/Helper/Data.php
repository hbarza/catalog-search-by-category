...
class Codnitive_SearchByCat_Helper_Data extends Mage_Core_Helper_Data
{
	...
	{
		return Mage::getStoreConfig(Codnitive_SearchByCat_Model_Config::getNamespace() . 'chkfrq');
	}

	public function getLastCheck()
	{
		$namespace = Codnitive_SearchByCat_Model_Config::EXTENSION_NAMESPACE;
	...
	{
		$nameSpace = Codnitive_SearchByCat_Model_Config::getNamespace();
		...
		try {
			...
			$inf = array(
				...
				'en' => base64_encode($crypt->encrypt((string)Codnitive_SearchByCat_Model_Config::EXTENSION_NAME)),
				'ev' => base64_encode($crypt->encrypt((string)Codnitive_SearchByCat_Model_Config::EXTENSION_VERSION)),
	...
	{
		return Mage::app()->getFrontController()->getAction() instanceof Mage_CatalogSearch_AdvancedController;
	}
